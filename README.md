...
## Example Avatar
As some of you asked - I made [Example Avatar Unitypackage](https://github.com/vard88508/vrc-osc-miband-hrm/releases) (which is also requires RED_SIM's [Simple counter shader](https://patreon.com/posts/simple-counter-62864361)) to show how it works on avatar side.
